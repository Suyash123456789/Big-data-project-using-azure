...
storage_account = "olistdatastorage"
application_id = "X"
directory_id = "X"
...
spark.conf.set(f"fs.azure.account.oauth2.client.secret.{storage_account}.dfs.core.windows.net", "X")
spark.conf.set(f"fs.azure.account.oauth2.client.endpoint.{storage_account}.dfs.core.windows.net", f"https://login.microsoftonline.com/{directory_id}/oauth2/token")

# COMMAND ----------

# Example for bronze layer
file_path = "X"

customers_df = spark.read.option("header", True).option("inferSchema", True).csv(file_path)
display(customers_df)


# COMMAND ----------

base_path = "abfss://olistdata@olistdatastorage.dfs.core.windows.net/bronze/"
...
final_df.write.mode("overwrite").parquet("abfss://olistdata@olistdatastoragesuyash.dfs.core.windows.net/silver")
